...
- See [feat/booking](https://github.com/abiolaah/restate_react_native_app/blob/feat/bookings) branch.

👉 **Help Center**: Extended the Help Center feature, so that users can view list of frequently asked questions, send a message via contact form and get contact information of the team see [feat/help](https://github.com/abiolaah/restate_react_native_app/tree/feat/help) branch.
